...
export const ENDPOINTS: EndpointDoc[] = [
  ...
  },
  {
    ...
    description:
      '**Admin only.** Returns every instance with full metadata. The **`apiKey` is not included** — it is only shown once at create/rotate. Use `POST .../keys/rotate` to mint a new one.\n\n```bash\ncurl -s "$BASE/v1/instances" -H "X-Api-Key: $ADMIN_API_KEY"\n```',
    tags: ['Instances'],
    security: true,
    params: [],
    bodyExample: null,
